    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return  httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.POST, "/membro/cadastrar").hasRole("ROLE_GERENTE")
                        .requestMatchers(HttpMethod.POST, "/membro/cadastrar").hasRole("ROLE_FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/membro/listar/membros").hasRole("ROLE_FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/membro/listar/membros").hasRole("ROLE_GERENTE")
                        .requestMatchers(HttpMethod.GET, "/membro/listar/produtos").hasRole("ROLE_FUNCIONARIO")
                        .requestMatchers(HttpMethod.GET, "/membro/listar/produtos").hasRole("ROLE_GERENTE")
                        .requestMatchers(HttpMethod.GET, "/membro/listar/produtos").hasRole("ROLE_MEMBRO")
